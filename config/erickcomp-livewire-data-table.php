        ...
        'tailwind3v1' => [
            ...
            'actions' => [
                ...
                'bulk-actions-and-per-page' => [
                    ...
                    'per-page' => [
                        'container' => ['class' => ['flex', 'gap-2', 'ml-auto', 'items-center']],
            ...
            'table' => [
                ...
                'thead' => [
                    ...
                    'tr' => [
                        'class' => ['text-left', 'font-semibold', 'text-gray-700', 'dark:text-gray-100'],
                        'th' => [
                ...
                'tfoot' => [
                    'class' => ['bg-gray-50', 'text-xs', 'text-gray-600'],
                ],
            ],

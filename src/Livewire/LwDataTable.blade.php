...
@if($dataTable->withoutDefaultStyles === false)
    ...
    <style>
        ...
        .lw-dt-container th:has(.{{ $dataTable->sortingClassPrefix }}) {
            cursor: pointer;
        }

        .lw-dt-container .{{ $dataTable->sortingClassPrefix }} {
        ...
        .lw-dt-container .{{ $dataTable->sortingClassPrefix }}.{{ $dataTable->sortingClassPrefix }}-none {
        ...
        .lw-dt-container .{{ $dataTable->sortingClassPrefix }}.{{ $dataTable->sortingClassPrefix }}-asc {
        ...
        .lw-dt-container .{{ $dataTable->sortingClassPrefix }}.{{ $dataTable->sortingClassPrefix }}-desc {
